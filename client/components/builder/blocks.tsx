...
export const blockSpecs: BlockSpec[] = [
  ...
  },
  {
    ...
    defaultNode: () => ({ id: nid(), type: "heading", props: { text: "Untitled Heading", level: 2, align: "left" } }),
  },
  {
    type: "paragraph",
    title: "Paragraph",
    icon: ({ className }) => iconText(className),
    defaultNode: () => ({ id: nid(), type: "paragraph", props: { text: "Write something inspiring about your event.", align: "left" } }),
  },
  {
    type: "button",
    title: "Button",
    icon: ({ className }) => iconButton(className),
    defaultNode: () => ({ id: nid(), type: "button", props: { label: "Register Now", href: "#" } }),
  },
  {
    type: "image",
    title: "Image",
    icon: ({ className }) => iconImage(className),
    defaultNode: () => ({ id: nid(), type: "image", props: { src: "/placeholder.svg", alt: "Image" } }),
  },
  {
    type: "two-column",
    title: "Two Columns",
    ...
    defaultNode: () => ({
      ...
      props: { gap: "gap-8" },
      children: [
        { id: nid(), type: "paragraph", props: { text: "Left column content", align: "left" } },
        { id: nid(), type: "paragraph", props: { text: "Right column content", align: "left" } },
      ],
    }),
  },
  {
  ...
  },
  {
    ...
    defaultNode: () => ({ id: nid(), type: "speaker", props: { name: "Guest Name", role: "Keynote", photo: "/placeholder.svg" } }),
  },
];
