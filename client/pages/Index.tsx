...
function sampleEventTemplate(): BuilderNode[] {
  ...
  sectionHero.children = [
    {
      id: `${sectionHero.id}_h1`,
      type: "heading",
      props: {
        text: "EVENT BUCKET Presents: Campus Fest 2025",
        level: 1,
        align: "center",
      },
    },
    {
      id: `${sectionHero.id}_p1`,
      type: "paragraph",
      props: {
        text: "A week of innovation, culture, and community. Join workshops, talks, and celebrations across campus.",
        align: "center",
      },
    },
    {
      id: `${sectionHero.id}_b1`,
      type: "button",
      props: { label: "Register Now", href: "#register" },
    },
  ];

  const sectionSchedule = blockSpecs
    .find((b) => b.type === "section")!
    .defaultNode();
  sectionSchedule.children = [
    {
      id: `${sectionSchedule.id}_h2`,
      type: "heading",
      props: { text: "Schedule", level: 2 },
    },
    blockSpecs.find((b) => b.type === "schedule")!.defaultNode(),
  ];

  const sectionSpeakers = blockSpecs
    .find((b) => b.type === "section")!
    .defaultNode();
  sectionSpeakers.children = [
    {
      id: `${sectionSpeakers.id}_h2`,
      type: "heading",
      props: { text: "Speakers", level: 2 },
    },
    {
      id: `${sectionSpeakers.id}_c1`,
      type: "two-column",
      props: { gap: "gap-8" },
      children: [
        {
          id: `${sectionSpeakers.id}_s1`,
          type: "speaker",
          props: {
            name: "Alex Kumar",
            role: "Keynote",
      ...
      {!isPreview && (
        <div className="hidden md:block">
          <LayersPanel
            ...
            setNodes={(u) =>
              setNodes((p) => (typeof u === "function" ? (u as any)(p) : u))
            }
          />
        </div>
      )}
          ...
          <div className="container mx-auto flex h-14 items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span className="hidden sm:inline">
                Build your event page with drag & drop
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="outline" onClick={doNew}>
                New
              </Button>
              ...
              <Button variant="outline" onClick={doExportJson}>
                Export JSON
              </Button>
              <Button onClick={() => setIsPreview((v) => !v)}>
              ...
              <div className="hidden md:flex items-center gap-2">
                    ...
                    onClick={() => {
                      ...
                      nodes[0].children = [
                        ...
                        },
                        {
                          ...
                          type: "paragraph",
                          props: {
                            text: "Join your campus club for a meetup and fun activities.",
                            align: "center",
                          },
                        },
                      ];
                      ...
                      s.children = [
                        {
                          id: `${s.id}_h`,
                          type: "heading",
                          props: { text: "Speakers Lineup", level: 1 },
                        },
                        blockSpecs
                          .find((b) => b.type === "speaker")!
                          .defaultNode(),
                      ];
                      setNodes([s]);
                ...
                <ThemePicker
                  onApply={(id) => toast.success(`Applied theme ${id}`)}
                />
              </div>
            </div>
          </div>
        ...
        <div className="bg-secondary/5 border-b p-4">
          <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
            <div className="text-sm text-muted-foreground">
              Tip: Drag blocks from the left into the canvas. Click a block to
              edit on the right. Use Save to persist in your browser.
            </div>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
